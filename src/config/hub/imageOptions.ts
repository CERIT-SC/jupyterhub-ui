...
export const imageOptions = {
  simple: {
    ...
    "cerit.io/hubs/minimalnb:15-07-2025-intelligence-ai":
      "Minimal NB with notebook-intelligence",
    "cerit.io/hubs/minimalnb:01-02-2025": "Minimal NB with SSH access",
    "cerit.io/hubs/minimalnb-cs:31-10-2024":
      "Minimal NB with Integrated VS Code",
    "cerit.io/hubs/minimalnb-cs:17-11-2024-ai":
      "Minimal NB with Integrated VS Code and AI",
    "cerit.io/hubs/datasciencenb:26-09-2024": "DataScience NB",
    "cerit.io/hubs/datasciencenb:31-10-2024-ssh":
      "DataScience NB with SSH access",
    "cerit.io/hubs/datasciencenb:2025-05-30-nrp": "DataScience NB for NRP",
  },
  r: {
    "cerit.io/hubs/jupyterhubronly:05-02-2024":
      "Python 3.11 and R 4.3.1 kernels",
  ...
  tf: {
    ...
    "cerit.io/hubs/tensorflowgpu:2.11.1":
      "TensorFlow 2.11.1 with GPU and TensorBoard",
    "cerit.io/hubs/tensorflowgpu:2.12.1":
      "TensorFlow 2.12.1 with GPU and TensorBoard",
    "cerit.io/hubs/tensorflowgpu:2.15.0":
      "TensorFlow 2.15.1 with GPU and TensorBoard",
    "cerit.io/hubs/tensorflowgpu:2.17.0":
      "TensorFlow 2.17.0 with GPU and TensorBoard",
