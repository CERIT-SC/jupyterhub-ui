...
import OidcTester from "./components/OidcTester";
import PrometheusApiTester from "./components/PrometheusApiTester";
import GpuMetricsTester from "./components/GpuMetricsTester";
import JupyterHubTester from "./components/JupyterHubTester";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 md:p-24 gap-8">
      ...
      >
        ...
        <div className="mt-6">
          <TabsContent className="w-full" value="oidc">
            <OidcTester />
          </TabsContent>
